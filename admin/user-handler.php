...
class UserHandler extends WordPressHooks {
  ...
  public function filter__wp_dropdown_users ( $html) {
    ...
    wp_enqueue_style('iufs-jquery-ui', plugin_dir_path( __FILE__ ) . 'admin/css/jquery-ui.min.css',[], INDEX_WP_USERS_FOR_SPEED_VERSION);
    wp_enqueue_style('iufs-jquery-ui-structure', plugin_dir_path( __FILE__ ) . 'admin/css/jquery-ui.structure.min.css',[], INDEX_WP_USERS_FOR_SPEED_VERSION);
    wp_enqueue_style('iufs-jquery-ui-theme', plugin_dir_path( __FILE__ ) . 'admin/css/jquery-ui.theme.min.css',[], INDEX_WP_USERS_FOR_SPEED_VERSION);
